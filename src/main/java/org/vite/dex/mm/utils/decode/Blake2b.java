...
import static org.vite.dex.mm.utils.decode.Blake2b.Engine.Assert.assertFail;
import static org.vite.dex.mm.utils.decode.Blake2b.Engine.Assert.exclusiveLowerBound;
import static org.vite.dex.mm.utils.decode.Blake2b.Engine.Assert.inclusiveLowerBound;
import static org.vite.dex.mm.utils.decode.Blake2b.Engine.Assert.inclusiveUpperBound;
import static org.vite.dex.mm.utils.decode.Blake2b.Engine.LittleEndian.readInt;
import static org.vite.dex.mm.utils.decode.Blake2b.Engine.LittleEndian.readLong;
import static org.vite.dex.mm.utils.decode.Blake2b.Engine.LittleEndian.writeInt;
import static org.vite.dex.mm.utils.decode.Blake2b.Engine.LittleEndian.writeLong;
...
//			Debug.dumpBuffer(System.out, "-- mac hash --", hash);
        ...
        private void compress(final byte[] b, final int offset) {
            ...
            m[0] = readLong(b, offset);
            m[1] = readLong(b, offset + 8);
            m[2] = readLong(b, offset + 16);
            m[3] = readLong(b, offset + 24);
            m[4] = readLong(b, offset + 32);
            m[5] = readLong(b, offset + 40);
            m[6] = readLong(b, offset + 48);
            m[7] = readLong(b, offset + 56);
            m[8] = readLong(b, offset + 64);
            m[9] = readLong(b, offset + 72);
            m[10] = readLong(b, offset + 80);
            m[11] = readLong(b, offset + 88);
            m[12] = readLong(b, offset + 96);
            m[13] = readLong(b, offset + 104);
            m[14] = readLong(b, offset + 112);
            m[15] = readLong(b, offset + 120);
